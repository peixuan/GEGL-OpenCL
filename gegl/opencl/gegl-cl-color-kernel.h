...
"#define RGB_LUMA_RED         (0.299f)                                                    \n"
"#define RGB_LUMA_GREEN       (0.587f)                                                    \n"
"#define RGB_LUMA_BLUE        (0.114f)                                                    \n"
"#define RGB_LUMINANCE_RED    RGB_LUMA_RED                                                \n"
"#define RGB_LUMINANCE_GREEN  RGB_LUMA_GREEN                                              \n"
"#define RGB_LUMINANCE_BLUE   RGB_LUMA_BLUE                                               \n"
"#endif                                                                                   \n"
"                                                                                         \n"
"/* CONV_1(10):RGBA float -> Y'CbCrA float */                                              \n"
"__kernel void rgba2ycbcra (__global const float4 * in,                                   \n"
"                           __global float4 * out)                                        \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v = in[gid];                                                                 \n"
...
"  red   = linear_to_gamma_2_2(in_v.x);                                                   \n"
"  green = linear_to_gamma_2_2(in_v.y);                                                   \n"
"  blue  = linear_to_gamma_2_2(in_v.z);                                                   \n"
"  out_v.x = 0.299f * red + 0.587f * green + 0.114f * blue;                               \n"
"  out_v.y = -0.168736f * red - 0.331264f * green + 0.5f * blue;                          \n"
"  out_v.z = 0.5f * red - 0.418688f * green - 0.081312f * blue;                           \n"
"  out_v.w = in_v.w;                                                                      \n"
"  out[gid] = out_v;                                                                      \n"
"}                                                                                        \n"
"                                                                                         \n"
"/* CONV_1(11):Y'CbCrA float -> RGBA float */                                              \n"
"__kernel void ycbcra2rgba (__global const float4 * in,                                   \n"
"                           __global float4 * out)                                        \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v = in[gid];                                                                 \n"
"  float4 out_v;                                                                          \n"
"  float red, green,blue;                                                                 \n"
"  red   = 1.0f * in_v.x + 0.0f * in_v.y + 1.40200f * in_v.z;                             \n"
"  green = 1.0f * in_v.x - 0.344136f * in_v.y - 0.71414136f * in_v.z;                     \n"
"  blue  = 1.0f * in_v.x + 1.772f * in_v.y + 0.0f * in_v.z;                               \n"
"  out_v.x = gamma_2_2_to_linear(red);                                                    \n"
"  out_v.y = gamma_2_2_to_linear(green);                                                  \n"
"  out_v.z = gamma_2_2_to_linear(blue);                                                   \n"
"  out_v.w = in_v.w;                                                                      \n"
"  out[gid] = out_v;                                                                      \n"
"}                                                                                        \n"
"/* CONV_1(12):RGBA float -> YA float */                                                  \n"
"__kernel void rgba2graya (__global const float4 * in,                                    \n"
"                          __global float2 * out)                                         \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v = in[gid];                                                                 \n"
"  float2 out_v;                                                                          \n"
"  float luminance;                                                                       \n"
"  luminance = in_v.x * RGB_LUMINANCE_RED +                                               \n"
...
"  out[gid] = out_v;                                                                      \n"
"}                                                                                        \n"
"/* CONV_1(13):YA float -> RGBA float */                                                  \n"
"__kernel void graya2rgba (__global const float2 * in,                                    \n"
"                          __global float4 * out)                                         \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float2 in_v = in[gid];                                                                 \n"
...
"  out[gid] = out_v;                                                                      \n"
"}                                                                                        \n"
"/* CONV_1(14):RGBA float -> Y float */                                                   \n"
"__kernel void rgba2gray (__global const float4 * in,                                     \n"
"                         __global float * out)                                           \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v = in[gid];                                                                 \n"
"  out[gid] = in_v.x * RGB_LUMINANCE_RED +                                                \n"
"             in_v.y * RGB_LUMINANCE_GREEN +                                              \n"
"             in_v.z * RGB_LUMINANCE_BLUE;                                                \n"
"}                                                                                        \n"
"/* CONV_1(15):Y float -> RGBA float */                                                   \n"
"__kernel void gray2rgba (__global const float * in,                                      \n"
"                         __global float4 * out)                                          \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 out_v;                                                                          \n"
...
"}                                                                                        \n"
"                                                                                         \n"
"/* CONV_1(16):RGBA float -> gray_alpha_premultiply float */                              \n"
"__kernel void rgba_to_gray_alpha_premultiplied(__global const float4 * in,               \n"
"                                               __global float2 * out)                    \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v = in[gid];                                                                 \n"
...
"              in_v.y * RGB_LUMINANCE_GREEN +                                             \n"
"              in_v.z * RGB_LUMINANCE_BLUE;                                               \n"
"  luminance = luminance * in_v.w;                                                        \n"
"  out_v.x = luminance;                                                                   \n"
"  out_v.y = in_v.w;                                                                      \n"
"  out[gid] = out_v;                                                                      \n"
"}                                                                                        \n"
"/* CONV_1(17):gray_alpha_premultiply float -> RGBA float */                              \n"
"__kernel void gray_alpha_premultiplied_to_rgba(__global const float2 * in,               \n"
"                                               __global float4 * out)                    \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float2 in_v = in[gid];                                                                 \n"
"  float4 out_v;                                                                          \n"
"  float luminance = in_v.x;                                                              \n"
"  if (in_v.y > BABL_ALPHA_THRESHOLD)                                                     \n"
"  {                                                                                      \n"
"     luminance = luminance / in_v.y;                                                     \n"
"  }                                                                                      \n"
"  else luminance = 0.0f;                                                                 \n"
"  out_v.xyz = luminance;                                                                 \n"
"  out_v.w = in_v.y;                                                                      \n"
...
"}                                                                                        \n"
"                                                                                         \n"
"/* CONV_1(18):RGBA float -> gray_gamma_2_2_premultiplied float */                        \n"
"__kernel void rgba2gray_gamma_2_2_premultiplied(__global const float4 * in,              \n"
"                                                __global float2 * out)                   \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float4 in_v = in[gid];                                                                 \n"
...
"              in_v.y * RGB_LUMINANCE_GREEN +                                             \n"
"              in_v.z * RGB_LUMINANCE_BLUE;                                               \n"
"  out_v.x = linear_to_gamma_2_2(luminance) * in_v.w;                                     \n"
"  out_v.y = in_v.w;                                                                      \n"
"  out[gid] = out_v;                                                                      \n"
"}                                                                                        \n"
"                                                                                         \n"
"/* CONV_1(19):gray_gamma_2_2_premultiplied float -> RGBA float */                        \n"
"__kernel void gray_gamma_2_2_premultiplied2rgba(__global const float2 * in,              \n"
"                                                __global float4 * out)                   \n"
"{                                                                                        \n"
"  int gid = get_global_id(0);                                                            \n"
"  float2 in_v = in[gid];                                                                 \n"
"  float4 out_v;                                                                          \n"
"  float luminance;                                                                       \n"
"  luminance = in_v.x /in_v.y;                                                            \n"
"  luminance = gamma_2_2_to_linear(luminance);                                            \n"
"  out_v.xyz = luminance;                                                                 \n"
"  out_v.w = in_v.y;                                                                      \n"
"  out[gid]= out_v;                                                                       \n"
"}                                                                                        \n";
