...
"    float4 gradient;                                                  \n"
"                                                                      \n"
"    minmax(pix_fm, pix_bm, pix_ml, pix_mr, pix_mm,                    \n"
"        &minval, &maxval);                                            \n"
"    gradient = 0.5f * fmax((maxval - pix_mm),(pix_mm - minval));      \n"
"                                                                      \n"
"    gradient =                                                        \n"
"        (pix_fl + pix_fm + pix_fr + pix_ml + pix_mr + pix_bl +        \n"
"         pix_bm + pix_br - 8.0f * pix_mm) >                           \n"
"         0.0f ? gradient : -1.0f * gradient;                          \n"
"    gradient.w = pix_mm.w;                                            \n"
"                                                                      \n"
"    out[gid1d] = gradient;                                            \n"
"}                                                                     \n"
